...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # nota che in main comando diciamo che input=output=1
        #parser.add_argument('--tnet_dim', type=list, default=[1,64,256,1], help=' punti in cui si attaccheranno AE')
        # nota che in main comando diciamo che input=output=1
        parser.add_argument('--aenet_dim', type=int, default=64, help=' feature AE')
        parser.add_argument('--weight', type=list, default=[1,1,1], help=' pesi AE')
        ...
        parser.add_argument('--return_layers', default=['input', 'first_conv', 'second_conv', 'third_conv', 'resnet_block_1', 'resnet_block_2', 'resnet_block_3', 'resnet_block_4', 'final_output'],
                            help=' layer in cui attacchiamo AE') #chiavi del dizionario
        parser.add_argument('--AE_to_train', default=None, help='AE to train') 
        ...
        parser.add_argument('--sepochs', default=10, type=int, metavar='N',
                            help='number of total epochs to initialize adaptor')
        parser.add_argument('--tepochs', default=10, type=int, metavar='N',
                            help='number of total epochs to during test') #loro nel paper mettono 5 d defualt
        # 1, 0, 1, 1, 1, 1 questi sono i val riportati nello script AE
        parser.add_argument('--use_online', default=False, type=bool )
