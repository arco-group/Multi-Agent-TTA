...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--continue_train', action='store_true', help='continue training: load the latest model: se lo attivi, il codice caricherà automaticamente l’ultimo modello salvato in checkpoints/[name]/ e continuerà l’addestramento da lì.')
        parser.add_argument('--epoch_count', type=int, default=1, help='the starting epoch count, we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>, ti permette di specificare da quale epoch far ripartire il conteggio.')
